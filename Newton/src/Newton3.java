...
public final class Newton3 {
     ...
     * @param y
     *            the error range decided by the user
     * @return estimate of square root
     */
    private static double sqrt(double x, double y) {//create a new parameter which
        //will be decided by the user.
        double guess = x;
        boolean valid = true;
        double WITHIN_ERROR = y;
    ...
    public static void main(String[] args) {
        ...
        while (!IfCont) {
            ...
            out.println();
            out.print("Please enter the error range you want it to be: ");
            double range = in.nextDouble();
            out.println("The square root of your input number is: "
                    + sqrt(input, range));
            out.print(
