...
public final class RSSReader {
     ...
     *
     * @param args
     *            the program prompt the user to input a URl link and a file
     *            name, then create a XMlTree base on the link and write it to
     *            file. and at the begining the will check if the url link is a
     *            rss feed.
     */
    public static void main(String[] args) {
        SimpleReader in = new SimpleReader1L();
        SimpleWriter out = new SimpleWriter1L();
        out.println("Please enter a URL link: ");
        String input = in.nextLine();
        out.println("Please enter a file name :");
